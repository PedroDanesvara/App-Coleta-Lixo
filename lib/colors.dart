...
//Paleta de cor em uma escala de cinza
  static const MaterialColor grayScale =
  ...
  static const MaterialColor grayScaleAccent =
...
//Paleta de cor em uma escala de azul claro
  static const MaterialColor lightBlueScale =
      MaterialColor(_lightBlueScalePrimaryValue, <int, Color>{
    50: Color(0xFFE2FAFC),
  ...
  static const MaterialColor lightBlueScaleAccent =
      MaterialColor(_lightBlueScaleAccentValue, <int, Color>{
...
//Paleta de cor de uma escala de cinza escuro
  static const MaterialColor darkGrayScale =
      MaterialColor(_darkGrayScalePrimaryValue, <int, Color>{
    50: Color(0xFFE5E5E5),
  ...
  static const MaterialColor darkGrayScaleAccent =
      MaterialColor(_darkGrayScaleAccentValue, <int, Color>{
